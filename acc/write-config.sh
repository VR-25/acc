...
cooldownCurrent=(${cooldown_current-${ccr-${cooldownCurrent[@]}}})
...
forceChargingStatusFullAt100=${force_charging_status_full_at_100-${fs-${forceChargingStatusFullAt100}}}
runCmdOnPause=(${run_cmd_on_pause-${rcp-${runCmdOnPause[@]}}})
dynPowerSaving=${dyn_power_saving-${dps-${dynPowerSaving}}}


"
cat $TMPDIR/.default-config-help
} > $config
